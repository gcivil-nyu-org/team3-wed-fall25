...
class CommunityFavorites(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(
                fields=["user_id", "-created_at"], name="idx_favorites_user_createdat"
            ),
        ]
        constraints = [
...
class CommunityReviews(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(
                fields=["bbl", "-created_at"], name="idx_reviews_bbl_createdat"
            ),
            models.Index(
                fields=["bbl", "rating"], name="idx_reviews_bbl_rating_nonnull"
            ),
        ...
        constraints = [
            models.CheckConstraint(
                ...
                | models.Q(rating__gt=0, rating__lte=5.0),
...
class CommunityReviewComments(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(
                fields=["review_id", "created_at"], name="idx_comments_review_created"
            ),
...
class CommunityMessages(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                fields=["receiver_id", "read_at"], name="idx_messages_inbox_unread"
            ),
            models.Index(
                fields=["receiver_id", "-created_at"], name="idx_messages_inbox_time"
            ),
            models.Index(
                fields=["sender_id", "-created_at"], name="idx_messages_outbox_time"
            ),
